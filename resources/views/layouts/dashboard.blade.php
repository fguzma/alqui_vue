<html>
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordin">
          ...
          <li class="nav-item" data-placement="right" data-toggle="tooltip" title="Cargo">
            ...
            <ul class="sidenav-second-level collapse" id="collapseCargo">
              ...
              <li >
                {!!link_to_route('personal.index', $title = 'Ver Cargo')!!}
              </li>
            </ul>
          </li>
    ...
    <!--<script>
      function ACliente()
      {
        console.log("AgregaCliente");
        var ruta="http://127.0.0.1:8080/prueba/";
        $.get(ruta, function(res){
         // console.log(res);
          jQuery("#maestro").append(res);
